...
$(document).ready(function(){
	document.getElementById('input_file').addEventListener('change', fileCheck);
});
/* 첨부파일로직*/
...
function fileCheck(e) {
	...
	reader.onload = function(e) {
		...
		'<div id="file'+ fileNum+ '" onclick="fileDelete(\'file'
		+ fileNum+ '\')">'+ '<font style="font-size:12px">'+ f.name+ '</font>'
...
function showUploadedFile(uploadResultArr) {
	...
	function(i, obj) {
		if (!obj.image) {
			...
			var fileCallPath = encodeURIComponent(obj.uploadPath+ "/thumb_"	+ obj.uuid
			+ "_"+ obj.fileName);
